...
paint_arrow(Container *root, Container *container) {
    ...
    auto info = gen_text_texture("Segoe Icons", data->text, 6 * config->dpi, color);
    draw_texture(info, container->real_bounds.x, container->real_bounds.y);
...
//    
//    draw_colored_rect(color, right_bounds);
//}
//
//static void
